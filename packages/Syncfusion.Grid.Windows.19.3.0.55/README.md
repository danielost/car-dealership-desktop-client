This package contains the following Syncfusion UI controls for Windows Forms.
...
[Release History](https://help.syncfusion.com/windowsforms/release-notes/v19.3.0.55?utm_source=nuget&utm_medium=listing&utm_campaign=windows-grid-nuget)
